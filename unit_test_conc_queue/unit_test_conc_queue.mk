...
##
## Release
ProjectName            :=unit_test_conc_queue
ConfigurationName      :=Release
WorkspacePath          := "/home/maxis11/sources/clang/snifer_clang"
ProjectPath            := "/home/maxis11/sources/clang/snifer_clang/unit_test_conc_queue"
...
ObjectsFileList        :="unit_test_conc_queue.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main$(ObjectSuffix): main.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/maxis11/sources/clang/snifer_clang/unit_test_conc_queue/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) "../.build-release/unit_test_conc_queue"
