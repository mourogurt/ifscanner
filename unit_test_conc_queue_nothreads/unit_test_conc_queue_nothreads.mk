...
##
## Release
ProjectName            :=unit_test_conc_queue_nothreads
ConfigurationName      :=Release
WorkspacePath          := "/home/maxis11/sources/clang/snifer_clang"
ProjectPath            := "/home/maxis11/sources/clang/snifer_clang/unit_test_conc_queue_nothreads"
...
ObjectsFileList        :="unit_test_conc_queue_nothreads.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/main$(ObjectSuffix) $(IntermediateDirectory)/snifer_clang_concurent_queue$(ObjectSuffix) 
...
$(IntermediateDirectory)/main$(ObjectSuffix): main.cpp 
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/maxis11/sources/clang/snifer_clang/unit_test_conc_queue_nothreads/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) "../.build-release/unit_test_conc_queue_nothreads"
